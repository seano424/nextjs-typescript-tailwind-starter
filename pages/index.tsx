...
const Home: NextPage = () => {
  return (
    <div className="min-h-screen px-2 flex flex-col justify-center items-center h-screen text-purple font-sans">
      <Head>
        <title>Next Tailwind TS Starter</title>
      ...
      <main className="py-20 flex-1 flex flex-col justify-center items-center text-center">
        <h1 className="m-0 leading-5 text-[40px] font-black lg:text-7xl pb-10">
          Next Tailwind TypeScript Starter Kit!
        </h1>

        <p className="leading-6 lg:text-2xl">
          Get started by editing{' '}
          <code className="bg-[#fafafa] rounded-md p-3 text-lg font-['Menlo, Monaco, Lucida Console, Liberation Mono, DejaVu Sans Mono']">
            pages/index.js
          </code>
        </p>
